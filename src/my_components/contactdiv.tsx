...
export const Contactdiv = () => {
    return(
        <div className='flex flex-col sm:flex-row items-center justify-between gap-4 mt-10 px-4'>
            <ContactForm />
            <span className={`${caveat.className} text-xl px-4 flex mt-4 sm:mt-0 border-l border-zinc-600 items-center w-[240px]`}> "Great brands aren't built by chance — they're
