...
export const Achieved = () => {
    return(
        <div className='flex flex-col mt-8'>
            <span className='font-medium tracking-normal text-gray-200'>some of my recent works : </span>
            <div className='mt-3 flex flex-wrap pl-8  gap-3 rounded-lg '>
                <ol className='list-disc text-gray-300 items-center'>
                    <li >
                        <div className='flex-row items-center gap-2 items-center mt-2'>
