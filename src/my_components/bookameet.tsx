...
export const Bookameat = () => {
    return(
        <div className='flex flex-wrap gap-2 mt-10 items-center'>
            ...
            <br />
            <div className='flex flex-row gap-3 items-center justify-between px-3 py-2 border border-transparent dark:border-zinc-700 border-zinc-200 cursor-pointer hover:shadow-md rounded-lg text-sm font-medium tracking-tight'>
